...
export default function ClassicTemplate({ resume, onSectionClick, inlineEditing = false }: Props) {
        ...
        >
          ...
          {projects.map((p, i) => (
            <div key={i} className="resume-item" data-section="projects" data-item-index={i}>
              <div className="resume-item-header">
              <InlineResumeField value={p.name} target={{ section: 'projects', index: i, field: 'name' }} enabled={inlineEditing} className="resume-item-title" />
                <span className="resume-item-date">
                  {p.start_date}
              ...
              {p.description && <div className="resume-item-desc"><InlineResumeField value={p.description} target={{ section: 'projects', index: i, field: 'description' }} enabled={inlineEditing} markdown /></div>}
            </div>
          ))}
        </div>
      ) : null,
        ...
        >
          ...
          {education.map((e, i) => (
            <div key={i} className="resume-item" data-section="education" data-item-index={i}>
              <div className="resume-item-header">
                <div>
                  <InlineResumeField value={e.institution} target={{ section: 'education', index: i, field: 'institution' }} enabled={inlineEditing} className="resume-item-title" />
                  {e.area && (
        ...
        >
          ...
          {awards.map((a, i) => (
            <div key={i} className="resume-item" data-section="awards" data-item-index={i}>
              <div className="resume-item-header">
                <div>
                <InlineResumeField value={a.title} target={{ section: 'awards', index: i, field: 'title' }} enabled={inlineEditing} className="resume-item-title" />
